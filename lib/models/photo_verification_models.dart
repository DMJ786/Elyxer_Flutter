/// Photo Verification Models (Module 5)
/// Holds height, language, photo, and selfie verification state.
library;

import 'package:freezed_annotation/freezed_annotation.dart';

part 'photo_verification_models.freezed.dart';
...
enum PhotoVerificationStep {
  height,
  language,
  photos,
  complete;

  bool get isLast => this == PhotoVerificationStep.complete;
}
...
@freezed
abstract class PhotoVerificationData with _$PhotoVerificationData {
  const factory PhotoVerificationData({
    int? heightFeet,
    int? heightInches,
    int? heightCm,
