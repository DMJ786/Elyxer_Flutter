...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthState&&(identical(other.status, status) || other.status == status)&&(identical(other.user, user) || other.user == user)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.lastProvider, lastProvider) || other.lastProvider == lastProvider));
}


@override
int get hashCode => Object.hash(runtimeType,status,user,errorMessage,lastProvider);

@override
String toString() {
  return 'AuthState(status: $status, user: $user, errorMessage: $errorMessage, lastProvider: $lastProvider)';
}
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? user = freezed,Object? errorMessage = freezed,Object? lastProvider = freezed,}) {
...
class _AuthState extends AuthState {
  const _AuthState({this.status = AuthStatus.unauthenticated, this.user, this.errorMessage = null, this.lastProvider = null}): super._();
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? user = freezed,Object? errorMessage = freezed,Object? lastProvider = freezed,}) {
