...
abstract class AppLocalizations {
  ...
  /// Heading on the verification completion screen.
  ///
  /// In en, this message translates to:
  /// **'Verification Complete!'**
  String get verificationCompleteTitle;

  /// Body text on the verification completion screen.
  ///
  /// In en, this message translates to:
  /// **'Your account has been successfully verified. You can now enjoy all features of the app.'**
  String get verificationCompleteBody;

  /// Header of the Moments tab. (Ready for migration once #62/#63 land.)
  ///
  /// In en, this message translates to:
  /// **'Moments'**
  ...
  /// No description provided for @discoverMagicSearch.
  ///
  /// In en, this message translates to:
  /// **'Magic Search'**
  String get discoverMagicSearch;
}
