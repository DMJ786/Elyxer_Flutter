/// Photo Verification Progress Indicator
/// 4-step progress bar: Height, Language, Photo, Complete
/// SVG assets live in assets/images/photo_verification/
library;
...
class PhotoVerificationProgressIndicator extends StatelessWidget {
  final PhotoVerificationStep currentStep;
  final Duration animationDuration;

  const PhotoVerificationProgressIndicator({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          _SvgStepIcon(
            assetBase: 'assets/photo_verification/HeightIcons',
          ...
          _SvgStepIcon(
            assetBase: 'assets/photo_verification/LanguageIcons',
            isActive: currentStep.index >= 1,
          ...
          _SvgStepIcon(
            assetBase: 'assets/photo_verification/PhotoUploadIcons',
            isActive: currentStep.index >= 2,
...
class _SvgStepIcon extends StatelessWidget {
  ...
  String get _svgAssetPath {
    if (isCompleted) return '$assetBase/state=Completed.svg';
    if (isActive) return '$assetBase/state=Inprogress.svg';
    return '$assetBase/state=Incomplete.svg';
  }
