...
class AddPhotoScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final photos = ref.watch(
      photoVerificationDataProvider.select((d) => d.photos),
    );
    final selfiePath = ref.watch(
      photoVerificationDataProvider.select((d) => d.selfiePhotoPath),
    );
  ...
  void _onRemovePhoto(WidgetRef ref, int index) {
    ref.read(photoVerificationDataProvider.notifier).removePhotoAt(index);
  }
